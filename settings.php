<?php
define('C_REST_CLIENT_ID','local.61791978ab2066.78950159');//Application ID
define('C_REST_CLIENT_SECRET','YIEYvwm8OtTpFUy74Li0wfNPjRFpsbc9QrQjnAwJKtZ6vYxCOA');//Application key
// or
